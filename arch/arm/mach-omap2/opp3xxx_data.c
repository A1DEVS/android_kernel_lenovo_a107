...
#if defined(CONFIG_OMAP36XX_OVERCLOCK)
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP130_UV, 0, OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
...
#if defined(CONFIG_OMAP36XX_OVERCLOCK)
#define OMAP36XX_MPU_OPP5_FREQ 1100000000
#endif
...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	/* MPU OPP5 - OPP-OC */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				OMAP36XX_MPU_OPP5_FREQ, OMAP3630_VDD_MPU_OPP1G_UV),
#else
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
